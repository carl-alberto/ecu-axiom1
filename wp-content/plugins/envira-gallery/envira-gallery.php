	...
	final class Envira_Gallery {
		...
		public function check_installation() {
			...
			if ( class_exists( 'Envira_Gallery_Lite' ) ) {
				...
				add_action( 'admin_notices', [ $this, 'lite_notice' ] );
			...
			if ( get_transient( 'envira_supersize_notice' ) ) {
				add_action( 'admin_notices', [ $this, 'supersize_notice' ] );
			}
			...
			if ( get_transient( 'envira_standalone_notice' ) ) {
				add_action( 'admin_notices', [ $this, 'standalone_notice' ] );
			}
		...
		public function beta_notice() {
			...
			$allowed = [ 'pro', 'agency', 'gold', 'ultimate', 'platinum' ];
