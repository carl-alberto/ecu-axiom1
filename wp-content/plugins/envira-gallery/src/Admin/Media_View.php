...
class Media_View {
	...
	public function __construct() {
		...
		// Attachment Defaults.
		add_action( 'admin_init', [ $this, 'default_link_type_settings' ] );
	...
	public function default_link_type_settings() {
		...
		if ( isset( $_REQUEST['post_type'] ) ) { // @codingStandardsIgnoreLine
			$post_type = sanitize_text_field( wp_unslash( $_REQUEST['post_type'] ) ); // @codingStandardsIgnoreLine
		} else {
			$post_type = false; }
	...
	public function print_media_templates() {
		...
		do_action( 'envira_print_media_templates' );
	}
