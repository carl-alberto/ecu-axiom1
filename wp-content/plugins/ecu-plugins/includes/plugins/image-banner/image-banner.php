<?php
	...
	class Image_Banner extends Abstract_Ecu_Shortcode {
		...
		public function initialize(){
			...
			if ( is_admin() ) {
				add_editor_style( plugins_url('/ecu-plugins/includes/plugins/image-banner/css/style.css') );
			}
		...
		public function enqueue_scripts() {
			wp_register_style( 'ecu-shortcode-image-banner', plugins_url('/ecu-plugins/includes/plugins/image-banner/css/style.css') );
		}
