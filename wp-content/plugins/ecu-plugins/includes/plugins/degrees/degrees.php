...
class Ecu_Degrees extends Abstract_Ecu_Shortcode {
	...
	public function admin_enqueue_scripts() {
		add_editor_style( plugins_url('/ecu-plugins/includes/plugins/degrees/css/style.css') );
	}
	...
	public function wp_enqueue_scripts() {
		wp_register_style( 'ecu-shortcode-degrees', plugins_url('/ecu-plugins/includes/plugins/degrees/css/style.css') );
	}
