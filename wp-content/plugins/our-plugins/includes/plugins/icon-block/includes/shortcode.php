<?php
	...
	class Icon_Block extends Abstract_Ecu_Shortcode {
		...
		if ( is_admin() ) {
			add_editor_style( plugins_url('/our-plugins/includes/plugins/icon-block/css/style.css') );
		}
	...
	public function enqueue_scripts() {
		wp_register_style( 'ecu-shortcode-icon-block', plugins_url('/our-plugins/includes/plugins/icon-block/css/style.css') );
	}
	    /**
