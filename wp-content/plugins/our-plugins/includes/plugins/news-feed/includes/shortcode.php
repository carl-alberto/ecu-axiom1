<?php
	...
	class News_Feed extends Abstract_Ecu_Shortcode {
		...
		public function admin_enqueue_scripts() {
			add_editor_style( plugins_url('/our-plugins/includes/plugins/news-feed/css/style.css') );
		}
		...
		public function wp_enqueue_scripts() {
			wp_register_style( 'ecu-shortcode-news-feed', plugins_url('/our-plugins/includes/plugins/news-feed/css/style.css') );
		}
