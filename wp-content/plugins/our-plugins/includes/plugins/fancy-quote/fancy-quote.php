<?php
	...
	class Fancy_Quote extends Abstract_Ecu_Shortcode {
		public function initialize(){
			...
			if ( is_admin() ) {
				add_editor_style( plugins_url('/our-plugins/includes/plugins/fancy-quote/css/style.css') );
			}
		...
		public function enqueue_scripts() {
			wp_register_style( 'ecu-shortcode-fancy-quote', plugins_url('/our-plugins/includes/plugins/fancy-quote/css/style.css') );
		}
	    /**
