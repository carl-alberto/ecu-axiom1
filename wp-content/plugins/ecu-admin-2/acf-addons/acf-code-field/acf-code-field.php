...
load_plugin_textdomain( 'acf-code-field', false, __DIR__ . '/lang/' );
...
add_action( 'acf/register_fields', 'register_fields_code_field',10,0 );


add_action( 'admin_notices', 'acf_check',10,0 );
