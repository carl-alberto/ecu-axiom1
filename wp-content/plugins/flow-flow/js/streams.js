        ...
        <dl class="section-settings section-compact">\
                ...
                <dd>\
                    ...
                    <label for="stream-<%= id %>-date-order">Strictly by date</label><br><br>\
                        ...
                        <dt class="multiline"><span class="ff-icon-lock"></span> Show lightbox on card click\
                        ...
                        <dt class="multiline"><span class="ff-icon-lock"></span> Lightbox type\
...
<dt>\
    ...
    <p class="desc"><a href="https://docs.social-streams.com/article/70-manual-premoderation" target="_blank">Learn more</a></p><div class="desc hint-block hint-block-pro"><span class="hint-link">Available in PRO</span><div class="hint hint-pro"><h1>PREMIUM FEATURE</h1>To access this and many other premium features please activate <a href="#addons-tab">BOOST subscription</a> or make one&#x2011;time purchase of <a href="http://goo.gl/g7XQzu" target="_blank">PRO version</a>.</div></div>\
</dt>\
<dd class="ff-feature">\
<label for="<%= uid %>-mod"><input id="<%= uid %>-mod" class="switcher" type="checkbox" name="<%= uid %>-mod" value="yep"/> <div><div></div></div></label>\
</dd>\
<dt>\
    <span class="ff-icon-lock"></span> Auto approve posts\
    <p class="desc">When moderation is enabled</p><div class="desc hint-block hint-block-pro"><span class="hint-link">Available in PRO</span><div class="hint hint-pro"><h1>PREMIUM FEATURE</h1>To access this and many other premium features please activate <a href="#addons-tab">BOOST subscription</a> or make one&#x2011;time purchase of <a href="http://goo.gl/g7XQzu" target="_blank">PRO version</a>.</div></div>\
</dt>\
<dd class="ff-feature">\
  ...
  <div class="feed-view" data-feed-type="instagram" data-uid="<%= uid %>">\
      ...
      <dl class="section-settings">\
          ...
          <input id="<%= uid %>-location-type" type="radio" name="<%= uid %>-timeline-type" value="location"/>\
            <label for="<%= uid %>-location-type">Location (only <a href="#addons-tab">Boost</a>)</label><br><br>\
          </dd>\
          <dt>\
            Content to show\
            <div class="desc hint-block">\
