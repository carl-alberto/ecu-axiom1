		...
		<div class='container'>
			<div class='row'>
				...
				<div class='col-12 col-sm-6 text-sm-right'>
					<div id='access-links'>©2017 | <a class='ecu-event-tracking' data-ga-category='Footer' data-ga-action='Terms' href='http://<?php echo getenv('TOPSITE_ENV'); ?>/terms'>Terms of Use</a> | <a class='ecu-event-tracking' data-ga-category='Footer' data-ga-action='Accessibility' href='http://<?php echo getenv('TOPSITE_ENV') ?>/accessibility/'>Accessibility</a> | <a class='ecu-event-tracking' data-ga-category='Footer' data-ga-action='Report a Barrier' href='https://<?php echo getenv('TOPSITE_ENV'); ?>/accessibility/report-a-barrier.cfm?referrer=http://<?php echo getenv('TOPSITE_ENV'); ?>'>Report a Barrier</a></div>
				</div>
			</div>
			<div class='row'>
				<div class='col-12 col-sm-6'>
					<div id='univ-actions'>
						<a class='btn btn-ecu-gold ecu-event-tracking' data-ga-category='Footer' data-ga-action='Give' href='https://give.ecu.edu'>GIVE TO ECU <span class="fa fa-chevron-right" aria-hidden="true"></span></a>
						<a class='btn btn-ecu-gold ecu-event-tracking' data-ga-category='Footer' data-ga-action='Apply' href='/apply'>APPLY <span class="fa fa-chevron-right" aria-hidden="true"></span></a>
					</div>
				</div>
