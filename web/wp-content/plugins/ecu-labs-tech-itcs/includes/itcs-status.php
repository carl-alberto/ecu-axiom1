...
namespace ECU\ITCSSTATUS;

// define shortcode for page
add_shortcode('ecu_itcs_status', 'ECU\ITCSSTATUS\show_status');

// define shortcode for alert
// [ecu_itcs_alert url="http://google.com"]
add_shortcode('ecu_itcs_alert', 'ECU\ITCSSTATUS\show_alert');

// define widget
add_action('widgets_init', 'ECU\ITCSSTATUS\ecu_itcs_load_widget',10,0);

// load specific scripts and styles
add_action('wp_enqueue_scripts', 'ECU\ITCSSTATUS\adding_scripts',10,0);

function ecu_itcs_load_widget() {
    register_widget('ECU\ITCSSTATUS\ecu_itcs_widget');
}
...
function adding_styles() {
    wp_register_style('ecu_itcs_css', '/wp-content/plugins/ecu-labs-tech-itcs/templates/itcs-status/itcs-status.css');
...
class ecu_itcs_widget extends \WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'ECU\ITCSSTATUS\ecu_itcs_load_widget', __('ECU ITCS Widget', 'ecu_itcs_widget_domain'),
