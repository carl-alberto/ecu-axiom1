<?php
    ...
    function enqueue_global_styles(){
        wp_register_style( 'wp-localist-shortcode-card', plugins_url('wp-localist/css/list.css') );
        wp_register_style( 'wp-localist-widget-card', plugins_url('wp-localist/css/grid.css') );
    }
