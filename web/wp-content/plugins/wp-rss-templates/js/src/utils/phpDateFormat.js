...
/**
 * Simple and small function for formatting date using PHP format.
 *
 * @see https://github.com/crocodile2u/js-date-format
 */
export function format (date, format) {
  return format.replace(FORMATREGEXP, (m) => FORMATS[m](date))
}
