...
use RebelCode\Wpra\Filtering\Modules\AddonModule;
use RebelCode\Wpra\Filtering\Modules\TemplatesModule;
...
add_action('plugins_loaded', function () {
    ...
    // Legacy WPRA Autoloader
    wprss_autoloader()->add('Aventura\\Wprss\\KeywordFiltering', WPRSS_KF_INC_DIR);
    // Composer Autoloader
    if (file_exists(WPRSS_KF_DIR . 'vendor/autoload.php')) {
        require_once WPRSS_KF_DIR . 'vendor/autoload.php';
    }
    ...
    // Load module
    wpra_load_module('filtering/addon', new AddonModule());
    wpra_load_module('filtering/templates', new TemplatesModule());
});
