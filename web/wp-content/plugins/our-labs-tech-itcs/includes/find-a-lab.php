...
// define shortcode
add_shortcode('ecu_labs_room_search', 'OUR\LABS\render_table');

// load specific scripts and styles
add_action( 'wp_enqueue_scripts', 'OUR\LABS\load_plugin_assets',10,0);
...
function adding_scripts() {
    wp_register_script('ecu_labs_js', plugins_url( '/our-labs-tech-itcs/templates/find-a-lab/find-a-lab.js' ) , array('jquery'), '1.1', true);
    wp_enqueue_script('ecu_labs_js');
    // add styles
    adding_styles();
}
function adding_styles() {
    wp_register_style('ecu_labs_css', plugins_url( '/our-labs-tech-itcs/templates/find-a-lab/find-a-lab.css') );
