<?php
	...
	class Text_Banner extends Abstract_Ecu_Shortcode {
		...
		public function initialize(){
			...
			if ( is_admin() ) {
				add_editor_style( plugins_url('/our-plugins/includes/plugins/text-banner/css/style.css') );
			}
		...
		public function enqueue_scripts() {
			wp_register_style( 'ecu-shortcode-text-banner', plugins_url('/our-plugins/includes/plugins/text-banner/css/style.css') );
		}
