<?php
	...
	class Directory_Information extends Abstract_Ecu_Shortcode {
		...
		public function initialize(){
			...
			if ( is_admin() ) {
				add_editor_style( plugins_url('/our-plugins/includes/plugins/profile/css/style.css') );
			}
		...
		public function enqueue_scripts() {
			wp_register_style( 'ecu-shortcode-profile', plugins_url('/our-plugins/includes/plugins/profile/css/style.css') );
		}
