<?php
	...
	class Social_Media extends Abstract_Ecu_Shortcode {
		...
		public function admin_enqueue_scripts() {
			add_editor_style(plugins_url('/our-plugins/includes/plugins/social-media/css/style.css') );
		}
		...
		public function wp_enqueue_scripts() {
			wp_register_style( 'ecu-shortcode-social-media', plugins_url('/our-plugins/includes/plugins/social-media/css/style.css') );
		}
