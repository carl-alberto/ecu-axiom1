<?php
	...
	class Image_Block extends Abstract_Ecu_Shortcode {
		...
		public function initialize(){
			...
			if ( is_admin() ) {
				add_editor_style( plugins_url('/our-plugins/includes/plugins/image-block/css/style.css') );
			}
		...
		public function enqueue_scripts() {
			wp_register_style( 'ecu-shortcode-image-block', plugins_url('/our-plugins/includes/plugins/image-block/css/style.css') );
		}
		/**
		 * Shortcode Function.
		 *
		...
		public function callback($attrs, $content = '', $shortcode_tag){
			...
			wp_enqueue_style('image-block-style', plugins_url('/our-plugins/includes/plugins/image-block/css/image-block.css'));
