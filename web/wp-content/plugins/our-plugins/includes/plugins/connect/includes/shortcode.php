<?php
	...
	class Ecu_Connect extends Abstract_Ecu_Shortcode {
		...
		public function enqueue_scripts() {
			wp_register_style( 'ecu-shortcode-connect', plugins_url('/our-plugins/includes/plugins/connect/css/style.css') );
		}
		...
		public function wp_enqueue_scripts() {
			wp_register_script('ecu-connect-scripts', plugins_url('our-plugins/includes/plugins/connect/js/script.js'));
		}
		...
		public function admin_enqueue_scripts() {
			wp_enqueue_script('ecu-connect-scripts', plugins_url('our-plugins/includes/plugins/connect/js/script.js'));
		}
