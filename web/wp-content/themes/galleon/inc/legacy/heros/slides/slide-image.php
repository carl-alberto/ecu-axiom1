<div class="slide">
    <img src="<?php echo $slide['image']['url']; ?>" alt="<?php if (isset($slide['image']['alt'])) echo $slide['image']['alt'] ?>" class="d-none d-sm-block d-md-block d-lg-block d-xl-block img-fluid img-stretch">
